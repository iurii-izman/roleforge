...
- **Runtime entrypoints:** `python -m roleforge.scheduler` (coordinated scheduled jobs), `python -m roleforge.jobs.gmail_poll`, `python -m roleforge.jobs.feed_poll`, `python -m roleforge.jobs.monitor_poll`, `python -m roleforge.jobs.replay`, `python -m roleforge.jobs.digest --dry-run`, `python -m roleforge.jobs.queue --dry-run`, `python -m roleforge.jobs.alert --dry-run`, `python -m roleforge.jobs.batch --dry-run`. Helpers: `scripts/seed_default_profile.py`, `scripts/run_scoring_once.py`, `scripts/inspect_gmail_message.py`.
