...
- **Applications (v5):** [v5 application lifecycle](docs/specs/v5-application-lifecycle.md). Additive Postgres: `schema/004_application_lifecycle.sql`, `schema/005_gmail_classified.sql` (TASK-072). [Inbox classifier](docs/specs/inbox-classifier.md) (TASK-073): deterministic rules for `gmail_messages.classified_as`; implementation in `roleforge.inbox_classifier` (TASK-075). [AI inbox classification contract](docs/specs/ai-inbox-classification-contract.md) (TASK-074) defines optional AI fallback for ambiguous messages. Telegram remains the operator control surface for application state changes.
